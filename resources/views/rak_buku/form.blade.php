...
<form method="POST" action="{{ $action }}">
    ...
    <input type="text" class="mail_text" id="nama" name="nama" place-holder="Nama Rak" value="{{ $rak->nama }}" /><br>
    @error('nama')
    <b>{{ $message }}</b>
    @enderror
    <br>
    ...
    <p><input type="text" id="datepicker" name="tanggal" place-holder="tanggal"></p>
